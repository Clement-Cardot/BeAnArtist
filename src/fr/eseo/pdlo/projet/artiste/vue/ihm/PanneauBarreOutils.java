...
public class PanneauBarreOutils extends JPanel{
	...
	private void initChoixForme(){
		...
		ActionChoisirForme actionRectangle = new ActionChoisirForme(this.panneauDessin, this, ActionChoisirForme.NOM_ACTION_RECTANGLE);
		ActionChoisirForme actionCarre = new ActionChoisirForme(this.panneauDessin, this, ActionChoisirForme.NOM_ACTION_CARRE);
		ActionChoisirForme actionEtoile = new ActionChoisirForme(this.panneauDessin, this, ActionChoisirForme.NOM_ACTION_ETOILE);
